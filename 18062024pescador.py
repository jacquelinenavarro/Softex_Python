...
peso = float(input("Digite o peso da pesca em quilos: "))
excesso = peso - 50
multa = excesso * 4

if peso <= 50:
    print("Você não ultrapassou os 50kg, portanto não precisará pagar multa! Parabéns!")

else:
    print(f"Você excedeu {excesso:.2f} kg, logo o valor da multa é R$ {multa:.2f}")
